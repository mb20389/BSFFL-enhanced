...
//
// weekOneDate is the Thursday 8:00 PM ET kickoff of Week 1, expressed in UTC
// (September is EDT, so 8:00 PM ET == 00:00 UTC the next day). BSFFL weeks run
// Thursday 8 PM ET → Thursday 8 PM ET from that anchor.

export const SEASONS = {
  "2026": {
    season: "2026",
    leagueId: "1389754614080880640",
    name: "SDFFL",
    // NFL 2026 opener: Thursday 9/10/2026, 8 PM ET.
    weekOneDate: "2026-09-11T00:00:00Z",
    totalWeeks: 18,
