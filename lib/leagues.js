...
// It also sets the weekday and time of day of every later turnover. Omit it and
// weeks are a uniform 7 days from weekOneDate.
//
// Every turnover is resolved against the Eastern-time clock and lands shortly
// before that week's first kickoff — Thanksgiving turns over in the morning
// automatically. earlyTurnoverDates can force the same early turnover on any
// other `YYYY-MM-DD` whose week starts with a daytime game.
